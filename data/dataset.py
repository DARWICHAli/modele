...
class COCO(PairedDataset):
    def __init__(self, image_field, text_field, img_root, ann_root, id_root=None, use_restval=True,
        ...
        roots['train'] = {
            ...
            'cap': os.path.join(ann_root, 'captions_train2014_tokenized.json')
        }
        roots['val'] = {
            'img': os.path.join(img_root, 'val2014'),
            'cap': os.path.join(ann_root, 'captions_val2014_tokenized.json')
        }
        roots['test'] = {
            'img': os.path.join(img_root, 'val2014'),
            'cap': os.path.join(ann_root, 'captions_val2014_tokenized.json')
    ...
    def get_samples(cls, roots, ids_dataset=None):
        ...
        for split in ['train', 'val', 'test']:
            ...
            for index in range(len(ids)):
                ...
                # print('filename:{}, caption:{}'.format(filename, caption))
